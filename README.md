...
- [`notebooks/10_synthetic_control_for_campaigns.ipynb`](notebooks/10_synthetic_control_for_campaigns.ipynb) - synthetic control style evaluation: covariates-only and donor-series modes.
